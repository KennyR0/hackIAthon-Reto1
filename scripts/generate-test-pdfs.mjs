...
const cases = [
  ...
  {
    file: "caso-4-informe-documento-faltante.pdf",
    title: "Informe medico hospitalario - Caso con documento faltante",
    lines: [
      "Hospital Vozandes Quito",
      "Informe preoperatorio de neurocirugia",
      "Paciente: Julian Mateo Cardenas Ponce",
      "Cedula: 1717171717",
      "Historia clinica: HC-NEU-2026-014",
      "Fecha de emision: 2026-05-13",
      "Poliza: POL-DOC-FALTANTE-004",
      "Diagnostico principal: Hernia discal lumbar L4-L5 con radiculopatia derecha persistente.",
      "Procedimiento solicitado: Microdiscectomia lumbar programada.",
      "Urgencia: Programada. Paciente estable, sin deficit neurologico progresivo ni riesgo vital inmediato.",
      "Observacion administrativa: el informe refiere que la resonancia magnetica fue realizada en otro centro y debe adjuntarse para auditoria.",
      "Medico tratante: Dra. Cristina Navas, Neurocirugia.",
    ],
  },
  {
    file: "caso-4-poliza-requiere-resonancia.pdf",
    title: "Poliza de seguro de salud - Caso con documento faltante",
    lines: [
      "Aseguradora: Pan-American Life Ecuador",
      "Numero de poliza: POL-DOC-FALTANTE-004",
      "Titular: Julian Mateo Cardenas Ponce",
      "Vigencia desde: 2025-06-01",
      "Vigencia hasta: 2026-12-31",
      "Plan: Plus",
      "Periodo de carencia para cirugias electivas: 120 dias.",
      "Coberturas: Neurocirugia, Cirugia de Columna, Traumatologia, Medicina Interna, Imagenologia.",
      "Tope quirurgico maximo: USD 18000.",
      "Condicion administrativa: toda cirugia de columna requiere resonancia magnetica vigente, orden quirurgica firmada y evolucion clinica de al menos seis semanas.",
      "Exclusiones: cirugia estetica, tratamientos experimentales, protesis no autorizadas previamente.",
    ],
  },
  {
    file: "caso-4-resonancia-complementaria.pdf",
    title: "Documento complementario - Resonancia magnetica",
    lines: [
      "Centro de Imagen Diagnostica Quito",
      "Paciente: Julian Mateo Cardenas Ponce",
      "Cedula: 1717171717",
      "Fecha de estudio: 2026-05-08",
      "Estudio: Resonancia magnetica de columna lumbar.",
      "Hallazgos: hernia discal posterolateral derecha L4-L5 con compromiso radicular concordante.",
      "Conclusion: hallazgos compatibles con indicacion quirurgica descrita por neurocirugia.",
      "Radiologo: Dr. Daniel Almeida.",
    ],
  },
];
